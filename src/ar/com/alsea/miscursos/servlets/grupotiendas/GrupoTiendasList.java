...
/**
 * Servlet implementation class GrupoTiendas
 */
@WebServlet("/GrupoTiendasList")
public class GrupoTiendasList extends HttpServlet {
		...
		try {
			...
			if (session != null) {
				...
				if (u != null) {
					...
					request.setAttribute("grupos", new GestorGrupoTiendas().TraerGrupos( u.getMarca() ) );
					request.getRequestDispatcher("gruposTiendas/gruposTiendas.jsp").forward(request, response);
